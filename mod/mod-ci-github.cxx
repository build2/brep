...
namespace brep
{
  ...
  try
  {
    ...
    // unbuilt ones, then the synthetic conclusion check run will be update in
    // build_completed(). Note that determining whether we have no more
