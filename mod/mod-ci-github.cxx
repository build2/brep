...
namespace brep
{
  ...
  handle (request& rq, response&)
  {
    ...
    if (event == "check_suite")
    {
      ...
      {
        // Branch pushes are handled in handle_push_request() so ignore this
        // event.
        //
        return true;
      }
  ...
  bool ci_github::
  handle_push_request (gh_push_event ps, bool warning_success)
  {
    HANDLER_DIAG;
    ...
    if (ps.forced || ps.deleted)
    {
      ...
      if (optional<tenant_service> ts = cancel (error, warn,
                                                ...
                                                *build_db_, retry_,
                                                ...
                                                true /* ref_count */))
      {
        l3 ([&]{trace << sub << ": attempted to cancel CI of previous"
      ...
      else
      {
        ...
        // various reasons (e.g., CI was not enabled).
        //
        l3 ([&]{trace << sub << ": failed to cancel CI of previous head commit"
                      << " with tenant_service id " << sid;});
      }
    }
