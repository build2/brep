...
print_usage (::std::ostream& os, ::cli::usage_para p)
{
  ...
  os << std::endl
     << "\033[1m--ignore-unresolved-tests\033[0m Ignore tests, examples, and benchmarks package" << ::std::endl
  ...
  os << std::endl
     << "\033[1m--tenant-load\033[0m             Load the repository and package information into the" << ::std::endl
     << "                          pre-created empty tenant rather than into the newly" << ::std::endl
     << "                          created one. Requires the \033[1m--tenant\033[0m option to be" << ::std::endl
     << "                          specified." << ::std::endl;

  os << std::endl
     << "\033[1m--private\033[0m                 Display the tenant packages in the web interface only" << ::std::endl
     << "                          in the tenant view mode." << ::std::endl;
  ...
  os << std::endl
     << "\033[1m--service-id\033[0m \033[4mid\033[0m           Third party service information to associate with the" << ::std::endl
     << "                          being created tenant. Requires the \033[1m--tenant\033[0m and" << ::std::endl
  ...
  os << std::endl
     << "\033[1mopenssl\033[0m \033[4mpath\033[0m              The openssl program to be used for crypto operations." << ::std::endl
     << "                          You can also specify additional options that should" << ::std::endl
     << "                          be passed to the openssl program with \033[1mopenssl-option\033[0m." << ::std::endl
     << "                          If the openssl program is not explicitly specified," << ::std::endl
     << "                          then \033[1mbrep-load\033[0m will use \033[1mopenssl\033[0m by default." << ::std::endl;

  os << std::endl
     << "\033[1mopenssl-option\033[0m \033[4mopt\033[0m        Additional option to be passed to the openssl program" << ::std::endl
     << "                          (see \033[1mopenssl\033[0m for details). Repeat this option to" << ::std::endl
...
struct _cli_options_map_init
{
  _cli_options_map_init ()
  {
    ...
    _cli_options_map_["--ignore-unresolved-tests"] =
    &::cli::thunk< options, &options::ignore_unresolved_tests_ >;
    _cli_options_map_["--tenant"] =
    &::cli::thunk< options, std::string, &options::tenant_,
      &options::tenant_specified_ >;
    _cli_options_map_["--tenant-load"] =
    &::cli::thunk< options, &options::tenant_load_ >;
