...
print_usage (::std::ostream& os, ::cli::usage_para p)
{
  ...
  os << std::endl
     << "\033[1m--private\033[0m             Display the tenant packages in the web interface only in" << ::std::endl
     << "                      the tenant view mode." << ::std::endl;

  os << std::endl
     << "\033[1m--interactive\033[0m \033[4mbkp\033[0m     Build the tenant packages interactively, stopping builds" << ::std::endl
     << "                      at the specified breakpoint. Implies \033[1m--private\033[0m." << ::std::endl;
