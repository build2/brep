...
namespace odb
{
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    b[n].type = pgsql::bind::text;
    b[n].buffer = i.machine_value.data_ptr ();
  ...
  "\"machine\"=$14, "
  "\"machine_summary\"=$15, "
  "\"controller_checksum\"=$16, "
  "\"machine_checksum\"=$17, "
  "\"agent_checksum\"=$18, "
  "\"worker_checksum\"=$19, "
  "\"dependency_checksum\"=$20 "
  ...
  query_statement (const query_base_type& q)
  {
    ...
    r += " INNER JOIN \"build_package\" ON";
    // From build.hxx:384:5
    r += brep::operator == (query_columns::build::id.package, query_columns::build_package::id) && query_columns::build_package::buildable;

    r += " LEFT JOIN \"build_tenant\" ON";
    // From build.hxx:387:5
  ...
  query_statement (const query_base_type& q)
  {
    ...
    r += " INNER JOIN \"build_package\" ON";
    // From build.hxx:396:5
    r += brep::operator == (query_columns::build::id.package, query_columns::build_package::id) && query_columns::build_package::buildable;

    r += " LEFT JOIN \"build_tenant\" ON";
    // From build.hxx:399:5
    r += query_columns::build_package::id.tenant == query_columns::build_tenant::id;
